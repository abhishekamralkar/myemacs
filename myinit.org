...
* try
  ...
  Nide to have a package, if you do not want to try packages before installation.
...
* org bullets
  ...
  Package to get nice bullets whicle in org-mode.
...
* fonts
  ...
  (add-to-list 'default-frame-alist
             (cond
              ...
              ((string-equal system-type "gnu/linux") '(font . "Hack Regular-12"))))
  #+end_src
