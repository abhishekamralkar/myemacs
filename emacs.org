...
#+begin_src emacs-lisp
  (if (eq system-type 'darwin)
      (set-face-attribute 'default nil :font "JetBrains Mono NL" :height 180 :weight 'regular)
               (set-face-attribute 'default nil :font "JetBrains Mono NL" :height 160 :weight 'regular))

  (if (eq system-type 'darwin)
         ;; Set the fixed pitch face
      (set-face-attribute 'fixed-pitch nil :font "JetBrains Mono NL" :height 180 :weight 'regular)
               (set-face-attribute 'fixed-pitch nil :font "JetBrains Mono NL" :height 160 :weight 'regular))

  (if (eq system-type 'darwin)
      ;; Set the variable pitch face
      (set-face-attribute 'variable-pitch nil :font "JetBrains Mono NL" :height 180 :weight 'regular)
    
    (set-face-attribute 'variable-pitch nil :font "JetBrains Mono NL" :height 160 :weight 'regular))
#+end_src
